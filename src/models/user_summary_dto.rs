...
pub struct UserSummaryDto {
    ...
    #[serde(rename = "apiCalls", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub api_calls: Option<Option<i64>>,
    #[serde(rename = "apiBytes", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub api_bytes: Option<Option<i64>>,
    #[serde(rename = "apiLastCall", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "allJobs", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub all_jobs: Option<Option<Vec<models::RepoDataJobDto>>>,
    #[serde(rename = "dataPoints", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub data_points: Option<Option<Vec<models::DataPointDto>>>,
    #[serde(rename = "repoPoints", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub repo_points: Option<Option<Vec<models::RepoPointDto>>>,
    #[serde(rename = "autoJobs", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
